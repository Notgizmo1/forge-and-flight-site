---
title: "The Blue UAS Cleared List Has a Structural Problem. Procurement Officers Need to Know About It."
date: 2026-05-06
description: "The Blue UAS Cleared List is a useful procurement tool. It is not a substitute for independent supply chain verification, and the architecture of the certification process creates conflicts of interest that every acquisition officer should understand before signing a purchase order."
keywords: "Blue UAS list problems, NDAA compliance verification, Blue UAS AUVSI conflict of interest, DoD drone procurement integrity, Blue UAS Chinese components, Skydio battery supply chain, DCMA Blue UAS, NDAA supply chain audit, defense drone procurement"
summary: "The Blue UAS Cleared List is widely trusted by procurement officers as proof of NDAA compliance. The architecture of the certification process, documented supply chain failures, and a structural conflict of interest in its assessment framework mean that trust needs to be informed, not automatic."
---

In a [previous analysis](/news/what-is-blue-uas/), we walked through what the Blue UAS Cleared List is, how it works, and what it means for acquisition. That article was descriptive. This one is critical.
...
*Forge & Flight Holdings designs and manufactures NDAA-compliant UAS platforms with fully documented, component-level supply chain traceability. [View our platforms](/platforms/) or [contact us](/contact/) to discuss your acquisition requirement. CAGE 18WR3 · SAM Active.*
